## [MosGeo](https://dora.team/) - наш сервис для визуализации спортивных объектов Москвы
...
Главная проблема всех этих обьектов в их востребованности. По данным открытой статистики, более половины из них привлекают только людей, живущих в непосредственной близости от спортивного объекта (не более 500 метров).
...
Имеющиеся инстурументы мы использовали для визуализации и анализа данных, имеющих местоположение, для их лучшего понимания, принятия решений и прогнозирования. Для наглядности сервиса мы подключили карту Москвы.
