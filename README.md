# GeoAnal - наш сервис для вузализации спортивных объектов Московской области
...
* В московской области активно функционируют 13,5 тысяч спортивных объектов
...
Самое главная задача сервиса - это аналитика расположения спортивных объектов в Московской области. Сервис наглядно на карте отображает спортивные объекты с его назначением и кратикм описанием. GeoAnal позволяет собрать данные по определенному району (у какого количества населения есть спортивные обьекты в пешей доступности, численность населения определенной зоны и количество спортивных объектов/площадок). С помощью методов машинного обучения сервис предлагает рекомендации по расположению новых спортивных объектов.  
...
Имеющиеся инстурументы мы использовали для визуализации и анализа данных, имеющих местоположение, для их лучшего понимания, принятия решений и прогнозирования. Для наглядности серваиса мы подключили карту Московской области. Также из открытых источников мы взяли расположение спортивных оъектов в области и описание к ним.  
...
``// ТУТ БЛЯТЬ КРАСИВАЯ СТАТИСТИКА, а не вот это``
...
### Результат
Результатом работы нашей команды стал полностью рабочий онлайн сервис геоаналитики спортивных объектов Московской области, который позволяет обеспечить полноценный анализ спортивной инфрастукруты города и помочь с расположением новых объектов.   
